...
#---------------------------------------------------------
S3_BUCKET="abzt-openedx-eu-prod-storage"
MONGODB_HOST="mongodb.openedx-devops.abzt.de:27017"
...
mongo
use abzt-openedx_prod_edx;
db.dropDatabase();
exit

mongorestore -d abzt-openedx_prod_edx ~/backups/mongodb/mongo-dump-${BACKUP_KEY}/edxapp --host $MONGODB_HOST
