...
cookiecutter --checkout $GITHUB_BRANCH \
            ...
            global_platform_name=abzt-openedx \
            global_platform_region=eu \
            global_platform_shared_resource_identifier=service \
            global_services_subdomain=service \
            global_aws_region=eu-north-1 \
            global_account_id=278208590461 \
            global_root_domain=openedx-devops.abzt.de \
            global_aws_route53_hosted_zone_id=Z1Z2RZNA7TA36B \
